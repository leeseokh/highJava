...
public class T08_EqualsHashCodeTest {
	 ...
	 * 해시함수에 의해 얻어지는 값은 해시 값, 해시코드, 해시체크섬 또는 간단하게 해시라고 한다.
	 * 
	...
	public static void main(String[] args) {
		   ...
		   System.out.println("p1, p2 등록 후 데이터");						//향상된 for문 사용가능 iterator 안쓰고. 단 
		   for(Person p : set) {										//iterable<E>속성이 있어야 함.?
		...
		class Person{
		   ...
		   public boolean equals(Object obj) {
		      ...
		      if (obj == null)
		         return false;
		      if (getClass() != obj.getClass()) //this.getClass() >> 현재 객체의 class 정보  p1.getClass
		         return false;
