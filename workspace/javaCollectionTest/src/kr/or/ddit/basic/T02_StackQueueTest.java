...
public class T02_StackQueueTest {
	...
	/*
	 	...
	 	Stack과 Queuesms LinkedList를 이용하여 사용할 수 있다.
	 */
		LinkedList<String> stack = new LinkedList<>(); //잦은 작업, 삭제 시 유용 but 검색시 느림.
		/*
		 	Stack의 명령
		 	1) 자료 입력: push(저장할 값)
		...
		/*
		 	Queue의 명령
		 	1)자료 입력: offer(저장할 값)
		 	2)자료 출력: poll  => 자료를Queue에서 꺼내온 후 꺼내온 자료는 Queue에서 삭제한다.		 	
		 */
